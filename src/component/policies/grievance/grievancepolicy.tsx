  ...
  const sections: any = {
    introduction: {
      ...
      content: `
        ...
        <p class="mt-4">FundsOnTime Private Limited (“the Company” or “FundsOnTime”) is a Non-Banking Financial Company (NBFC) registered with the Reserve Bank of India (“RBI”). As a responsible financial institution committed to ethical business practices and regulatory compliance, FundsOnTime places the highest priority on providing transparent, fair, and customer-centric services.</p><br/>
    ...
    scope: {
      ...
      content: `
         ...
         <p class="text-sm  text-black ">It applies to all offices, branches, business correspondents, agents, and digital platforms of FundsOnTime, irrespective of geographic location.</p>
         </div>
    ...
    channel: {
      ...
      <div class=" grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <img src="/icons/email.png" alt="" class="p-4" />
             ...
             <p class="ml-8 mt-8 mb-4">  care@fundsontime.com</p>
             </div> 
            </div>
    ...
    ombudsman: {
      ...
      content: `
        <div class="space-y-4">
          <p>FundsOnTime shall establish a robust grievance redressal framework.</p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-blue-700">
                    ...
                    Officer at{" "}
                    <a
                      href="mailto:  care@fundsontime.com"
                      className="underline font-semibold"
                    >
                      care@fundsontime.com
                    </a>
                  </p>
                </div>
              </div>
